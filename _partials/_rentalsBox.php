...
<div class="box1">
    ...
    <?php if ($_SESSION['isLoggedIn'] == true) { ?>
        <input type="checkbox" class="checkbox" id="<?= $image['id'] ?>" />
                ...
                <div class="content">
                    ...
                    <form class="cssform">
                        ...
                        <div class="cssform-checkbox">
                            <input type="checkbox" name="checkbox" id="<?php echo $image['id'] ?>">
                            <label for="<?php echo $image['id'] ?>">Cochez cette case</label>
                        </div>
        ...
        <div id="<?php echo $image['id-carr']; ?>" class="carousel slide">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="carouselImg" src="<?php echo $image[0]; ?>" class="d-block w-100" alt="...">
                </div>
